...
css/js are cached 1h — after a deploy, hard reload (Ctrl+Shift+R) before judging client-rendered features (pace chart, saved list, progress bars), or the browser may run the pre-deploy app.js.
