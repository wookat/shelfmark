...
- Pass 3 (QA residual tail): deleted 7 report-imprint series (101 entries) — ASCL infosheet/themakaart, Fifth Thule Expedition reports, Swedish Government Official reports, English Heritage / Wessex / Colchester archaeological reports — and 2 now-empty author rows (Curt Teichert, Dick Foeken). QA verified across all three surfaces (styled-404 suggestions, search fallback, 11 sitemap parts): no academic leakage; Massey Lectures kept and intact.

## R174–175 (discovery walkthrough → genre aliases, related genres, pen-name display)
- R174 recorded discovery walkthrough (home → genres → mystery → Agatha Raisin → tick → book → similar → lists → studies → shelf): tracker/progress/similar/lists/studies all clean; P0/P1 none. Findings: `/genres/mystery` 404s while the mystery corpus is fragmented across Crime (38) / Detective (25) / Mystery Fiction (13); Agatha Raisin surfaces show Marion Chesney everywhere though readers know M. C. Beaton; "novel by Marion Chesney" stub repeats ×8 on the series list; genres index renders "Comics Of The United States".
- R175 fixes:
  - Genre aliases: 12 reader-facing slugs (mystery, crime, detective, horror, sci-fi/scifi, ya/young-adult, children/childrens/kids, mysteries) 301 to canonical genre pages via GENRE_SLUG_REDIRECTS.
  - "Related genres" pill row on genre pages from six neighbouring-genre clusters (mystery/crime/detective/thriller/spy, fantasy subgenres, SF subgenres, horror, romance, children/YA) — only live genres rendered.
  - Pen-name display (D1): author renamed to M. C. Beaton (slug m-c-beaton, bio "Pen name of Marion Chesney, British writer (1936–2019)"); series description and 8 book stubs updated; /authors/marion-chesney 301s via new AUTHOR_SLUG_REDIRECTS.
...
## R176 (catalog curation pass 4: reference/report imprint tail)
- Data driver: fresh search-term log showed QA probes like "lecture notes" / "research report" / "similarity search" still returning academic imprints, and keyword sweeps ("survey", "archaeology", "handbook", "statistics", "studies", "publications", …) surfaced a residual tail R173's name-pattern passes missed.
- Fix (D1): deleted 70 more reference/report/institutional series (~1,030 entries), reviewed row-by-row — geological survey reports (2nd Pennsylvania, Maryland), CRS/Draper/Open-File reports, BAR British/International + supplementary archaeological report series, East Anglian Archaeology, Wellcome Witnesses seminar transcripts, Oxford Handbooks/Companions/Paperback Reference, Garland reference libraries, Springer/Wiley statistics imprints, Schaum's outlines, encyclopedias/dictionaries/catalogues (National Gallery, Palaearctic Coleoptera, technical dictionaries), academic "Studies in …" series, journals (African Dynamics, NY Botanical Garden Memoirs), and authored academic monograph sets (Treatise on Basic Philosophy, Pigment Compendium, The Algorithmic Monographs). Empty author rows removed and affected author counts recomputed.
- Deliberately kept (book-shaped): Massey Lectures, Dehio handbook (Buildings-of-England analog), Classici dell'arte + Künstler-Monographien (published art/biography book series), Official Toki Pona (Sonja Lang), The Country Home Library, Companions Quartet (Julia Golding fiction), The Flashman Papers / Gonzo Papers etc. (fiction with report-like names).
- Verified live: "handbook"/"papers"/"statistics"/"reference"/"studies" searches now return only book-shaped results; deleted slugs 404; catalog now 2,510 series / 182,317 books.

## R177 (curation pass 5 + Julia Golding attribution)
- QA-surfaced tail from R176's 404 suggestion lists: deleted 3 residual reference series (Handbuch der Politik, The Oxford History of Historical Writing, Handbuch zum Evangelischen Gesangbuch — 7 entries); empty author rows cleaned.
- Companions Quartet had no author entity: Wikidata Q28406631 P50 → Q6306437 Julia Golding ("British fiction writer", b. 1969; mul label, no en label — why the P50 audit script skipped it). Inserted the author and attributed the series + 4 books.
- Decision: 1920s "Best Continental Short Stories … Yearbook" anthologies kept — genuinely book-shaped published annuals.
- Verified live: 3 slugs 404, /authors/julia-golding 200, series page links the author.

## R178 (weekly maintenance)
- IndexNow full resubmission: 44,896 URLs (6 batches, all 200) — down from 47,115 after the R173/176/177 curation passes.
- Endpoint health check: 23 key routes all 200 (manifest is /manifest.json).

## R179–180 (ten-round competitor deep revisit → /compare layer)
