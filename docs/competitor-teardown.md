...
## R170 revisit (2026-08-10)
booksinorder.io nav unchanged (18 links, same as R160); /studies now has 4 studies: longest-book-series, authors-with-most-books, series-completion-times, series-on-hiatus. /guides holds ~50+ editorial reading-order guides (per-series long-form). BSIO homepage unchanged. Adopted: longest-gaps study (verifiable from our own book years). Declined: series-on-hiatus (unverifiable editorial claim about a series' future), per-series editorial guides (our series pages already serve the intent with data, no compliant editorial source).
